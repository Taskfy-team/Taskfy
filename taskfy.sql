...
INSERT INTO `chat` (`id_chat`, `mensagem_chat`, `data_mensagem`, `fk_equipe`, `fk_tarefa`, `fk_usuario`) VALUES
(1, 'Comecei a documentação hoje.', '2025-07-07', 10, 13, 15),
(2, 'Rafael, adicione também os endpoints de login.', '2025-07-07', 10, 13, 12),
(3, 'Primeira entrevista marcada para amanhã!', '2025-07-07', 11, 14, 16);
...
(4, 'sei la', 'Grupo de tarefa', 'ativo', 6, 2),
...
(9, 'Desenvolvimento Cató', 'Desenvolvimento de software para católic', 'ativo', 1, 3),
(10, 'Equipe Gamma', 'Equipe de QA e testes', 'ativo', 12, 3),
(11, 'Equipe UX', 'Designers e prototipação', 'ativo', 13, 3);
...
(10, 'Criar API', 'Criar API para receber informações da ca', 'Aberta', 1, 9, '2025-07-07', '2025-07-12'),
(11, 'Criar testes unitári', 'Cobertura de testes para API', 'Pendente', 12, 10, '2025-07-07', '2025-07-14'),
(12, 'Melhorar protótipos', 'Atualizar Figma com novos fluxos', 'Aberta', 13, 11, '2025-07-07', '2025-07-12'),
(13, 'Documentar API', 'Criar documentação Swagger completa', 'Em andamen', 15, 10, '2025-07-07', '2025-07-17'),
(14, 'Coletar feedbacks', 'Entrevistar 5 usuários sobre o protótipo', 'Aberta', 16, 11, '2025-07-07', '2025-07-11');
...
--
-- Despejando dados para a tabela `timeline_tarefa`
--

INSERT INTO `timeline_tarefa` (`id_timeline`, `mensagem_timeline`, `data_timline`, `anexo_timeline`, `fk_equipe`, `fk_tarefa`, `fk_usuario`) VALUES
(1, 'Teste\r\n', '2025-07-06', NULL, NULL, 2, 6),
(2, 'oii\r\n', '2025-07-06', NULL, NULL, 2, 8),
(3, 'Opa\r\n', '2025-07-07', NULL, NULL, 10, 1),
(4, 'Teste', '2025-07-07', NULL, NULL, 12, 13);
...
(11, 'Marcelo S.', 'marceloos@email.com', '123', NULL, NULL, '', 'ativo'),
(12, 'Lucas Mendes', 'lucas@email.com', '123', '1994-04-12', '2025-01-05', '991234567', 'ativo'),
...
--
ALTER TABLE `tarefas`
  MODIFY `id_tarefa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `usuario_equipe`
  MODIFY `id_usr_equipe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de tabela `usuario_tarefa`
--
ALTER TABLE `usuario_tarefa`
  MODIFY `id_use_taf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
